...
public class GameActivity extends AppCompatActivity {
    ...
    private static final String FAIL_EVENT_KEY = "stage_failed";
    private static final String CLEAR_EVENT_KEY = "stage_clear";
    ...
    private void clearStage () {
        ...
        mFirebaseAnalytics.logEvent(CLEAR_EVENT_KEY, null);
    ...
    private void failStage () {
        // Send log event to Firebase.
        mFirebaseAnalytics.logEvent(FAIL_EVENT_KEY, null);
